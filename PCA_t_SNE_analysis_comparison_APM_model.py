"""PCA for generated molecules with focus on PIM1 kinase: with and without Activity Prediction Model 
...
df_with_APM= pd.read_csv("scores_smiles_filtered_final_test_prior_20ep_agent_20ep_APM_model.csv")
...
df_with_APM["Parameters"] = 'Including Activity Prediction Model'

df_without_APM["Parameters"] = 'Excluding Activity Prediction Model'
...
ax = sns.scatterplot(data=crds_df, x="PC_1", y="PC_2", hue="Parameters", palette={'Including Activity Prediction Model': "green",'Excluding Activity Prediction Model': "red"})

# Add a bold title to the plot
plt.title('PCA - use case - Activity Prediction Model', fontweight='bold')
plt.show()
...
ax = sns.scatterplot(data=tsne_df, x="X", y="Y", hue="Parameters", palette={'Including Activity Prediction Model': "green",'Excluding Activity Prediction Model': "red"})
plt.title('t-SNE - use case - Activity Prediction Model', fontweight='bold')
plt.show()
