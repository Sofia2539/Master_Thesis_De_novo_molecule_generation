"""PCA for generated molecules with focus on PIM1 kinase: with and without inception inlcuded in the parameters"""
...
df_with_inception= pd.read_csv("/home/sofia/Downloads/Datasets/PIM1 Kinase/REINVENT_RL_demo/Final_Tests/Prior_20ep/scores_smiles_filtered_final_test_prior_20ep_agent_20ep.csv")
...
df_with_inception["Parameters"] = 'Including Inception'

df_without_inception["Parameters"] = 'Excluding Inception'


# Concatenate the datasets
combined_df = pd.concat([df_with_inception, df_without_inception, df_inception], ignore_index=True)
...
ax = sns.scatterplot(data=crds_df, x="PC_1", y="PC_2", hue="Parameters", size="Size", sizes=(50, 200), legend="full", palette={'Including Inception': "green",'Excluding Inception': "red", 'Inception SMILES': "blue"})
...
ax = sns.scatterplot(data=tsne_df, x="X", y="Y", hue="Parameters", size="Size", sizes=(50, 200), legend="full", palette={'Including Inception': "green",'Excluding Inception': "red", 'Inception SMILES': "blue"})
